        ...
        : Controller
    {
        ...
        public async Task<IActionResult> GenerateExcel(string masterFileType, CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                var safeMasterFileTypeForLog = masterFileType.Replace("\r", " ")
                    .Replace("\n", " ");
                logger.LogError(ex, "Failed to generate {MasterFileType} master file excel. Error: {ErrorMessage}, Stack: {StackTrace}. Generated by: {UserName}",
                    safeMasterFileTypeForLog, ex.Message, ex.StackTrace, userManager.GetUserName(User));
                return RedirectToAction("Index", "Home");
            }
        }
