...
{
    public class MsapSupplierRepository(ApplicationDbContext db): Repository<MsapSupplier>(db), IMsapSupplierRepository
    {
        ...
        {
            return await _db.MsapSuppliers
        ...
        public async Task UpdateAsync(MsapSupplier model, CancellationToken cancellationToken = default)
        {
            var existingSupplier = await _db.MsapSuppliers
